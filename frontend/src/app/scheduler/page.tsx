        ...
        <div className="space-y-8 animate-fade-in">
            <div>
                ...
                <p className="text-gray-500 mt-1 text-sm">
                    Deep Q-Network agent · Energy-difficulty matching · Identity-aligned ordering
                </p>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <MetricCard title="Tasks Scheduled" value="7" icon="✓" color="cyan" />
                <MetricCard title="Breaks Inserted" value="1" icon="🧘" color="amber" subtitle="burnout prevention" />
            </div>
            ...
            <div className="glass-card overflow-hidden">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1">
                                Tasks ordered by RL agent · Energy-matched time slots
                            </p>
                        </div>
                        <button className="px-4 py-2 rounded-xl bg-aurora-700/20 border border-aurora-700/30 text-aurora-400 text-sm font-medium hover:bg-aurora-700/30 transition-colors">
                            Re-optimize
                        </button>
                    </div>
                </div>
                ...
                <div className="divide-y divide-white/5">
                    {scheduleData.map((item, i) => (
                        <div
                            key={i}
                            className={`flex items-center gap-6 px-6 py-4 transition-colors hover:bg-white/[0.02] ${item.status === "break" ? "bg-violet-950/10" : ""
                                }`}
                        >
                            {/* Time */}
